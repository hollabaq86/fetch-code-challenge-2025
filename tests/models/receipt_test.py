...
def test_assign_points(retailer, purchase_date, purchase_time, items, total, expected_points):
	datum = {
		"retailer": retailer,
		"purchaseDate": purchase_date,
		"purchaseTime": purchase_time,
...
def test_assign_points_counts_retailer_alphanumeric_characters(retailer, expected_count):
	datum = {
		"retailer": retailer,
...
def test_assign_points_checks_purchase_date(retailer, purchase_date, purchase_time, items, total, expected_points):
	datum = {
		"retailer": retailer,
		"purchaseDate": purchase_date,
		"purchaseTime": purchase_time,
...
def test_assign_points_checks_purchase_time(retailer, purchase_date, purchase_time, items, total, expected_points):
	datum = {
		"retailer": retailer,
		"purchaseDate": purchase_date,
		"purchaseTime": purchase_time,
